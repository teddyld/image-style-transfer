...
class Transform(nn.Module):
    ...
    def forward(self, content4_1, style4_1, content5_1, style5_1):
        adain_outputs_4_1 = self.adain(content4_1, style4_1)
        adain_output_5_1 = self.adain(content5_1, style5_1)

        upsampled_5_1 = self.upsample(adain_output_5_1)

        # Combine
        merged_features = self.merge_conv(self.merge_conv_pad(adain_output_4_1 + upsampled_5_1))
...
def style_transfer(vgg, decoder, content, style, alpha=1.0,
    ...
    return decoder(feat), content_loss, style_loss